...
DUEL_BOARD: tuple[BoardSpace, ...] = (
    ...
    BoardSpace(
        position=12, type=SpaceType.CORNER, name="Duel Parking", corner=CornerVariant.PARKING
    ),
    _street(
        13,
        "Harbor Road",
    ...
    BoardSpace(position=16, type=SpaceType.CHANCE, name="Duel Chance"),
    _street(
        17,
        "Crown Avenue",
        200,
    ...
    BoardSpace(
        position=18, type=SpaceType.CORNER, name="Go to Duel Jail", corner=CornerVariant.GOTO_JAIL
    ),
    _street(
        19,
        "Redstone Plaza",
    ...
    BoardSpace(position=20, type=SpaceType.TAX, name="Luxury Toll", tax_amount=75),
    _utility(21, "Water Grid"),
    BoardSpace(position=22, type=SpaceType.CHANCE, name="Duel Chance"),
    _street(
        23,
        "Victory Boulevard",
        260,
